...
|---|-----------|--------|--------|
| **M0** | Repo scaffold + CI + host CPU lints/builds in Verilator | Tooling works end-to-end | 🚧 in progress |
| **M1** | MMIO launch handshake + single-lane kernel execution | Offload + done handshake, one thread runs a real kernel | ⏳ |
