...
savings. Finally, two evaluation extensions are in progress: a design-space
sweep over lane and warp counts to produce area/frequency/throughput Pareto
fronts, and an open-source ASIC path through the SkyWater~130\,nm
PDK~\cite{sky130} using OpenLane~\cite{openlane}, which would turn the FPGA PPA
